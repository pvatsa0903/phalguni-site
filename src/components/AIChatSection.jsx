...
const KB = [
  ...
  // ── Why Hire ────────────────────────────────────────────────────
  {
    ...
    response:
      "What makes Phalguni stand out as a PM:\n\n🧩 Clarity in complexity — Takes ambiguous spaces (monetization, onboarding, international growth) and breaks them into clear problem definitions, sharp hypotheses, and focused execution. Most teams don't struggle with ideas — they struggle with structure.\n\n🧠 AI-native, not AI-buzzword — Built a multi-layer ML health-scoring engine combining wearable & behavioral data to deliver real-time health scores and next-best-action recommendations. Genuine technical depth, not just buzzwords.\n\n🎯 Data-first — A/B experimentation at scale, behavioral analytics, funnel analysis across 13M+ users. Starts with how users actually behave.\n\n💻 Technical depth — Python, SQL, APIs. Engineers respect her because she speaks their language.\n\n🚀 Proven outcomes — $17M+ wallet & incentives platform → 30% YoY revenue growth. 20% activation lift. 30% engagement lift. 15% faster member activation.\n\n🤝 Cross-functional leadership — 10+ years aligning engineering, design, UX, Data Science, and Operations (6 teams, 200+ contributors, 30+ stakeholders at CVS alone) across CVS Health, Autodesk, and more.\n\nIf you're working on hard, ambiguous problems that need clarity and structure — she's your PM.",
  },
