...
const KB = [
  ...
  // ── About / Intro ───────────────────────────────────────────────
  {
    ...
    response:
      "Phalguni Vatsa is a Sr. Product Manager with 10+ years of experience and a foundation in software engineering and data, building and scaling B2B and B2C SaaS products serving 18M+ users and generating $17M+ in annual revenue.\n\nShe specializes in growth, monetization, activation, experimentation, AI-powered products, CRM, global payments, and 0→1 product development. Currently at Brillio, she owns AI product discovery, strategy, and delivery for a Fortune 1000 healthcare client — translating high-impact business problems into production-ready GenAI products. Before that, at CVS Health, she drove 0→1 delivery of a HIPAA-compliant multi-agent AI assistant and a $17M+ monetization platform.\n\nWhat sets her apart: most teams don't struggle with ideas — they struggle with structure. She takes ambiguous spaces and breaks them into clear problem definitions, sharp hypotheses, and focused execution paths.\n\nShe's grown from Software Engineer → Project Lead → Product Owner → AI & Digital Platform PM → Sr. PM, AI Product Strategy — a rare end-to-end perspective most PMs don't have. She holds an MS in Business Analytics from Purdue Krannert and is a Certified SAFe® Agilist.",
  },
  ...
  // ── Current Role (Brillio) ──────────────────────────────────────
  {
    keywords: [
      "current role", "current job", "brillio",
      ...
      "fortune 1000", "healthcare client", "center of excellence", "coe",
    ],
    response:
      "Phalguni is currently a Sr. Product Manager — AI Product Strategy & Delivery at Brillio (Jul 2026–Present, contract), working with a Fortune 1000 healthcare client remotely from San Francisco:\n\n• Owns AI product discovery, strategy, and delivery — identifying high-impact business problems and translating them into production-ready GenAI products\n• Partners directly with executive stakeholders, product marketing, engineering, data science, and UX to define AI roadmaps, prioritize investments, and deliver measurable business outcomes\n• Partners with the client's AI Center of Excellence (CoE) to evaluate enterprise GenAI use cases, shape AI strategy, and establish best practices for scalable, responsible AI adoption\n\nBefore this, she spent 2.5 years at CVS Health driving AI product delivery — ask me about CVS for details!",
  },

  // ── CVS Health Role ─────────────────────────────────────────────
  {
    keywords: [
      "cvs health", "cvs role", "at cvs", "cvs",
      "ai assistant", "wallet and incentives",
    ],
    response:
      "At CVS Health (Feb 2024–Jul 2026, contract via APN Consulting), Phalguni was a Product Manager — AI & Digital Platform, owning AI product delivery and growth strategy for an 18M+ user Health & Wellness platform:\n\n• Drove 0→1 delivery of a HIPAA-compliant multi-agent AI assistant (GenAI, RAG, LLM routing, agent orchestration) → 50K+ monthly queries, 20% lower support costs\n• Established an AI lifecycle governance framework for PHI-handling systems → adopted across 8 teams\n• Owned product strategy for a $17M+ GMV digital wallet, aligning 5 teams and 70+ contributors → ~30% YoY revenue growth\n• Defined product vision for an ML-powered health scoring system (wearable + behavioral data) → 15% faster member activation\n• Led A/B experimentation and 0→1 onboarding redesign for 18M+ users → 20% activation lift\n• Gamified features, membership tiering, and multichannel notifications → 30% engagement lift, 10% feature adoption lift, 30% interaction lift\n\nShe was the primary product contact for 150+ stakeholders across regulatory, legal, clinical, and engineering.",
  },
  ...
  // ── Experience / Career History ─────────────────────────────────
  {
    ...
    response:
      "Phalguni has 10+ years of experience across five companies (plus a data science internship):\n\n📍 Brillio (Jul 2026–Present, contract) — Sr. Product Manager, AI Product Strategy & Delivery, San Francisco (Remote)\nAI product discovery & delivery for a Fortune 1000 healthcare client · executive stakeholder partnership · AI Center of Excellence collaboration\n\n📍 CVS Health (Feb 2024–Jul 2026, via APN Consulting) — Product Manager, AI & Digital Platform, San Francisco\nHIPAA-compliant multi-agent AI assistant (GenAI/RAG/LLM) · 50K+ monthly queries · AI governance across 8 teams · ML health-scoring system · $17M+ GMV digital wallet · 30% YoY revenue growth · 18M+ user platform\n\n📍 Autodesk (Jan 2022–Sep 2023) — Product Owner, Go To Market Platform, San Francisco\n$5B+ ARR subscription business · VoC Dashboard · NPS +20 pts · 7% retention improvement · 10% revenue growth · Emerging markets pilot\n\n📍 Tredence Inc. (Aug–Nov 2021) — Data Science Intern, San Francisco\nML framework for A/B testing automation · 20% turnaround time reduction\n\n📍 Merck KGaA (Jan–Dec 2020) — Project Lead, Bengaluru\nUser journey analysis · 20% customer growth · 30% session duration increase\n\n📍 Yash Technologies (Apr 2018–Jan 2020) — Software Engineer, Bengaluru\n15% revenue increase · 25% churn reduction · 30% lead time reduction\n\nShe's grown from Software Engineer → Project Lead → Product Owner → AI & Digital Platform PM → Sr. PM, AI Product Strategy — a rare end-to-end perspective that makes her a far sharper product leader.",
  },
  ...
  // ── Skills ──────────────────────────────────────────────────────
  {
    ...
    response:
      "Phalguni's skills span PM craft + technical depth:\n\n🎯 Product & Systems\nOnboarding & Activation, Monetization & Incentives, Personalization & Insights, Retention Systems, AI-Assisted Prototyping, GenAI/LLM/RAG, AI Lifecycle Governance, Agent Orchestration, Go-to-Market (GTM), Product Roadmap, Cross-functional Leadership\n\n🛠️ Tools & Technical\nA/B Testing, Experimentation, OKRs & KPIs, Amplitude, Google Analytics, SQL, APIs, Claude, Lovable\n\n📈 Growth & Monetization\nFunnel Optimization, Activation/Retention, Personalization, CRM, Monetization Strategy, Global Payments, AI-driven Experimentation, PLG\n\nThis combo is rare — she earns engineering trust by speaking their language and has shipped a HIPAA-compliant multi-agent AI assistant and a $17M+ GMV digital wallet to prove it.",
  },
  ...
  // ── AI / ML Background ──────────────────────────────────────────
  {
    keywords: [
      ...
      "ml experience", "data analytics background", "health scoring engine",
      "hipaa compliant ai", "multi-agent ai assistant", "genai experience",
      "rag llm", "ai governance", "phi compliant",
      "ai", "nlp", "llm", "ml", "rag", "genai", "hipaa", "governance",
      "data science", "multi-agent",
    ],
    response:
      "Phalguni's AI/ML background goes well beyond the buzzword level:\n\n• Drove 0→1 delivery of a HIPAA-compliant multi-agent AI assistant at CVS Health — GenAI, RAG, LLM routing, and agent orchestration across Salesforce & SharePoint, supporting 50K+ monthly queries and cutting support costs by 20%\n• Built an AI lifecycle governance framework (prompt guardrails, escalation thresholds, feedback loops) — adopted across 8 teams\n• Built a multi-layer ML health-scoring engine combining wearable & behavioral data to deliver real-time health scores and next-best-action recommendations → 15% faster member activation\n• Completed AI For Everyone (Coursera, 2019) — early adopter before it was trendy\n• Built real ML models: sentiment analysis (84.37% acc), purchase intent (85.45% acc)\n• Shipped a live AI-powered product: StockPulse (weekly-stock-ace.lovable.app)\n• Currently exploring AI agents, markdown workflows, and AI orchestration\n\nFor a PM, this technical AI fluency — especially navigating PHI compliance for GenAI at production scale — is genuinely rare and valuable.",
  },
  ...
  // ── Growth & Monetization ───────────────────────────────────────
  {
    ...
    response:
      "Growth & Monetization is Phalguni's core domain:\n\n• Led product strategy for a $17M+ GMV digital wallet at CVS Health → ~30% YoY revenue growth\n• Agentic AI assistant handling 50K+ monthly queries → 20% lower support costs\n• Multi-layer ML health-scoring engine → 15% faster member activation\n• Gamified features, membership tiering, and multichannel notifications → 30% engagement lift, 10% feature adoption lift, 30% interaction lift across 18M+ users\n• Led A/B experimentation for 0→1 onboarding redesign → 20% activation improvement\n• Drove 10% revenue growth at Autodesk ($5B+ ARR) through personalized checkout\n• Emerging markets pilot at Autodesk — validated go/no-go via A/B experiments with data science\n\nShe approaches growth with the precision of a scientist — define the metric, run the experiment, ship what works.",
  },
  ...
  // ── Why Hire ────────────────────────────────────────────────────
  {
    ...
    response:
      "What makes Phalguni stand out as a PM:\n\n🧩 Clarity in complexity — Takes ambiguous spaces (agentic AI, monetization, onboarding) and breaks them into clear problem definitions, sharp hypotheses, and focused execution. Most teams don't struggle with ideas — they struggle with structure.\n\n🧠 AI-native, not AI-buzzword — Currently leads AI product strategy & delivery for a Fortune 1000 healthcare client at Brillio. At CVS Health, drove 0→1 delivery of a HIPAA-compliant multi-agent AI assistant (GenAI, RAG, LLM routing, agent orchestration) handling 50K+ monthly queries, and built the governance framework that let 8 teams safely deploy PHI-handling AI. Few PMs can ship GenAI at this scale in a regulated environment.\n\n🎯 Data-first — A/B experimentation at scale, behavioral analytics, funnel analysis across 18M+ users. Starts with how users actually behave.\n\n💻 Technical depth — Python, SQL, APIs. Engineers respect her because she speaks their language.\n\n🚀 Proven outcomes — $17M+ GMV digital wallet → 30% YoY revenue growth. 20% support cost reduction. 20% activation lift. 15% faster member activation.\n\n🤝 Cross-functional leadership — 10+ years aligning engineering, design, UX, Data Science, and Operations (5 teams, 70+ contributors, 150+ stakeholders at CVS alone) across CVS Health, Autodesk, and more.\n\nIf you're working on hard, ambiguous problems that need clarity and structure — she's your PM.",
  },
