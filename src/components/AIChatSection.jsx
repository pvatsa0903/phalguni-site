...
const KB = [
  ...
  // ── Why Hire ────────────────────────────────────────────────────
  {
    ...
    response:
      "What makes Phalguni stand out as a PM:\n\n🧩 Clarity in complexity — Takes ambiguous spaces (onboarding, subscriptions, international growth) and breaks them into clear problem definitions, sharp hypotheses, and focused execution. Most teams don't struggle with ideas — they struggle with structure.\n\n🎯 Data-first — A/B experimentation at scale, behavioral analytics, funnel analysis across 30M+ users. Starts with how users actually behave.\n\n💻 Technical depth — Python, SQL, ML-integrated products, APIs. Engineers respect her because she speaks their language.\n\n🚀 Proven outcomes — $17M+ GMV platform → 30% YoY revenue growth. 30% retention lift. +20 NPS. 15% faster time-to-value.\n\n🤝 Cross-functional leadership — 10 years aligning engineering, design, GTM, and exec stakeholders at CVS Health, Autodesk, and more.\n\n🧠 AI-native — Built AI-powered personalization platform in production at CVS. Uses AI as thinking partner throughout the product lifecycle.\n\nIf you're working on hard, ambiguous problems that need clarity and structure — she's your PM.",
  },
