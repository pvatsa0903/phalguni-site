...
const KB = [
  ...
  // ── About / Intro ───────────────────────────────────────────────
  {
    ...
    response:
      "Phalguni Vatsa is a Product Manager with 10+ years of experience and a foundation in software engineering and data, building and scaling B2B and B2C SaaS products serving 13M+ users and generating $17M+ in annual revenue.\n\nShe specializes in growth, monetization, activation, experimentation, AI-powered products, CRM, global payments, and 0→1 product development. At CVS Health, she leads cross-functional initiatives across UX, Data Science, Engineering, and Operations — aligning 6 teams, 200+ contributors, and 30+ stakeholders to deliver measurable business and customer outcomes.\n\nWhat sets her apart: most teams don't struggle with ideas — they struggle with structure. She takes ambiguous spaces and breaks them into clear problem definitions, sharp hypotheses, and focused execution paths.\n\nShe's grown from Software Engineer → Senior Software Engineer → Project Lead → GTM PM → AI & Digital Products PM — a rare end-to-end perspective most PMs don't have. She holds an MS in Business Analytics from Purdue Krannert and is a Certified SAFe® Agilist.",
  },
  ...
  // ── Current Role ────────────────────────────────────────────────
  {
    ...
    response:
      "At CVS Health (Feb 2024–Present), Phalguni is a Product Manager — AI & Digital Products, owning AI product delivery for a 13M+ user Health & Wellness platform:\n\n• Drove 0→1 delivery of a HIPAA-compliant multi-agent AI assistant (GenAI, RAG, LLM routing, agent orchestration) across Salesforce & SharePoint → 50K+ monthly queries, 20% lower support costs\n• Built a multi-layer ML health-scoring engine (wearable + behavioral data) → 15% faster member activation\n• Membership tiering system → 10% feature adoption lift\n• Gamified features (Badges, Streaks, Team Challenges) → 30% engagement lift\n• Led A/B experimentation and 0→1 onboarding redesign → 20% activation improvement\n• Led product strategy for a $17M+ wallet & incentives platform → ~30% YoY revenue growth\n\nShe aligns 6 teams, 200+ contributors, and 30+ stakeholders across UX, Data Science, Engineering, and Operations.",
  },
  ...
  // ── Skills ──────────────────────────────────────────────────────
  {
    ...
    response:
      "Phalguni's skills span PM craft + technical depth:\n\n🎯 Product & Systems\nOnboarding & Activation, Monetization & Incentives, Personalization & Insights, Retention Systems, AI-Assisted Prototyping, GenAI/LLM/RAG, Agent Orchestration, Go-to-Market (GTM), Product Roadmap, Cross-functional Leadership\n\n🛠️ Tools & Technical\nA/B Testing, Experimentation, OKRs & KPIs, Amplitude, Google Analytics, SQL, APIs, Claude, Lovable\n\n📈 Growth & Monetization\nFunnel Optimization, Activation/Retention, Personalization, CRM, Monetization Strategy, Global Payments, AI-driven Experimentation, PLG\n\nThis combo is rare — she earns engineering trust by speaking their language and has shipped a HIPAA-compliant multi-agent AI assistant and a $17M+ GMV platform to prove it.",
  },
  ...
  // ── Why Hire ────────────────────────────────────────────────────
  {
    ...
    response:
      "What makes Phalguni stand out as a PM:\n\n🧩 Clarity in complexity — Takes ambiguous spaces (agentic AI, onboarding, international growth) and breaks them into clear problem definitions, sharp hypotheses, and focused execution. Most teams don't struggle with ideas — they struggle with structure.\n\n🧠 AI-native, not AI-buzzword — Drove 0→1 delivery of a HIPAA-compliant multi-agent AI assistant (GenAI, RAG, LLM routing, agent orchestration) handling 50K+ monthly queries and cutting support costs by 20%. Few PMs can ship GenAI at this scale in a regulated environment.\n\n🎯 Data-first — A/B experimentation at scale, behavioral analytics, funnel analysis across 13M+ users. Starts with how users actually behave.\n\n💻 Technical depth — Python, SQL, APIs. Engineers respect her because she speaks their language.\n\n🚀 Proven outcomes — $17M+ rewards platform → 30% YoY revenue growth. 20% support cost reduction. 20% activation lift. 15% faster member activation.\n\n🤝 Cross-functional leadership — 10+ years aligning engineering, design, UX, Data Science, and Operations (6 teams, 200+ contributors, 30+ stakeholders at CVS alone) across CVS Health, Autodesk, and more.\n\nIf you're working on hard, ambiguous problems that need clarity and structure — she's your PM.",
  },
