...
const KB = [
  ...
  // ── CVS Health Role ─────────────────────────────────────────────
  {
    ...
    response:
      "At CVS Health (Feb 2024–Jul 2026, contract via APN Consulting), Phalguni was a Product Manager — AI & Digital Platform, owning AI product delivery and growth strategy for a 18M+ user Health & Wellness platform:\n\n• Drove 0→1 delivery of a HIPAA-compliant multi-agent AI assistant (GenAI, RAG, LLM routing, agent orchestration) → 50K+ monthly queries, 20% lower support costs\n• Established an AI lifecycle governance framework for PHI-handling systems → adopted across 8 teams\n• Built a multi-layer ML health-scoring engine (wearable + behavioral data) → 15% faster member activation\n• Led product strategy for a $17M+ wallet & incentives platform → ~30% YoY revenue growth\n• Owned backlog across 6 cross-functional teams; 0→1 onboarding redesign → 20% activation lift\n• Membership tiering, gamified engagement features, and multichannel notifications → 40% engagement boost, 30% retention lift, 30% interaction lift\n\nShe was the primary product contact for 150+ stakeholders across regulatory, legal, clinical, and engineering.",
  },
