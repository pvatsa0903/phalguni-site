...
const KB = [
  ...
  // ── Current Role ────────────────────────────────────────────────
  {
    ...
    response:
      "At CVS Health (Feb 2024–Present, contract via APN Consulting), Phalguni is a Product Manager — AI & Digital Platform, owning AI product delivery for a 30M+ user health platform:\n\n• Drove 0→1 delivery of a HIPAA-compliant multi-agent AI assistant (RAG + LLM routing across Salesforce & SharePoint)\n• Established an AI lifecycle governance framework for PHI-handling systems → adopted across 8 teams\n• Built a multi-layer ML health-scoring engine (wearable + behavioral + clinical data) → 15% faster time-to-value\n• Led MCP integration across Apple Health, pharmacy & insurance APIs → cut integration time from 3 months to 3 weeks, +22% activation, +18% 60-day retention\n• Owned backlog across 6 cross-functional teams; 0→1 onboarding redesign → 20% activation lift\n• Led AI-informed strategy for a $17M+ rewards platform → ~30% YoY revenue growth\n• Primary product contact for 150+ stakeholders across regulatory, legal, clinical & engineering",
  },
  ...
  // ── Growth & Monetization ───────────────────────────────────────
  {
    ...
    response:
      "Growth & Monetization is Phalguni's core domain:\n\n• Led AI-informed strategy for a $17M+ rewards platform at CVS Health → ~30% YoY revenue growth\n• MCP-integrated data pipelines (Apple Health, pharmacy, insurance) → +22% activation, +18% 60-day retention\n• Multi-layer ML health-scoring engine → 15% faster time-to-value\n• Led A/B experimentation for 0→1 onboarding redesign across 30M+ users → 20% activation improvement\n• Drove 10% revenue growth at Autodesk ($5B+ ARR) through personalized checkout\n• Emerging markets pilot at Autodesk — validated go/no-go via A/B experiments with data science\n\nShe approaches growth with the precision of a scientist — define the metric, run the experiment, ship what works.",
  },
  ...
  // ── Why Hire ────────────────────────────────────────────────────
  {
    ...
    response:
      "What makes Phalguni stand out as a PM:\n\n🧩 Clarity in complexity — Takes ambiguous spaces (GenAI governance, onboarding, international growth) and breaks them into clear problem definitions, sharp hypotheses, and focused execution. Most teams don't struggle with ideas — they struggle with structure.\n\n🧠 AI-native, not AI-buzzword — Drove 0→1 delivery of a HIPAA-compliant multi-agent AI assistant (RAG + LLM) and built the governance framework that let 8 teams safely deploy PHI-handling AI systems. Few PMs can navigate compliance and GenAI delivery at once.\n\n🎯 Data-first — A/B experimentation at scale, behavioral analytics, funnel analysis across 30M+ users. Starts with how users actually behave.\n\n💻 Technical depth — Python, SQL, APIs, MCP integration. Engineers respect her because she speaks their language.\n\n🚀 Proven outcomes — $17M+ rewards platform → 30% YoY revenue growth. +22% activation. +18% 60-day retention. 15% faster time-to-value.\n\n🤝 Cross-functional leadership — 10 years aligning engineering, design, legal, compliance, and exec stakeholders (150+ at CVS alone) at CVS Health, Autodesk, and more.\n\nIf you're working on hard, ambiguous problems that need clarity and structure — she's your PM.",
  },
