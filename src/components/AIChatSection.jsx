...
const KB = [
  ...
  // ── About / Intro ───────────────────────────────────────────────
  {
    ...
    response:
      "Phalguni Vatsa is a Product Manager with 10+ years of experience and a foundation in software engineering and data, building and scaling B2B and B2C SaaS products serving 13M+ users and generating $17M+ in annual revenue.\n\nShe specializes in growth, monetization, activation, experimentation, AI-powered products, CRM, global payments, and 0→1 product development. At CVS Health, she leads AI product delivery — including a HIPAA-compliant multi-agent AI assistant — and cross-functional initiatives across UX, Data Science, Engineering, and Operations, aligning 6 teams, 200+ contributors, and 150+ stakeholders to deliver measurable business and customer outcomes.\n\nWhat sets her apart: most teams don't struggle with ideas — they struggle with structure. She takes ambiguous spaces and breaks them into clear problem definitions, sharp hypotheses, and focused execution paths.\n\nShe's grown from Software Engineer → Senior Software Engineer → Project Lead → GTM PM → AI & Digital Platform PM — a rare end-to-end perspective most PMs don't have. She holds an MS in Business Analytics from Purdue Krannert and is a Certified SAFe® Agilist.",
  },
